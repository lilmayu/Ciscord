...
public final class SakuyaBridgeLogger extends ExtendedLoggerWrapper {
     ...
     */
    public static SakuyaBridgeLogger create() {
        final Logger wrapped = LogManager.getLogger();
        return new SakuyaBridgeLogger(wrapped);
    }
     ...
     */
    public static SakuyaBridgeLogger create(final Class<?> loggerName) {
     ...
     * @return The custom Logger.
     */
    public static SakuyaBridgeLogger create(final Class<?> loggerName, final MessageFactory messageFactory) {
     ...
     * @return The custom Logger.
     */
    public static SakuyaBridgeLogger create(final Object value) {
     ...
     * @return The custom Logger.
     */
    public static SakuyaBridgeLogger create(final Object value, final MessageFactory messageFactory) {
     ...
     * @return The custom Logger.
     */
    public static SakuyaBridgeLogger create(final String name) {
     ...
     * @return The custom Logger.
     */
    public static SakuyaBridgeLogger create(final String name, final MessageFactory messageFactory) {
